...
namespace AplicacionWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new UsuarioAplicacion{ UserName = Input.UserName, Email = Input.Email, Nombres = Input.Nombres, EmailConfirmed = true };
